...
(pas de Compose), réponses en **streaming** token par token.
...
La barre sous le titre indique `Connecté à jz-mini-1 (backend echo)` quand tout va
bien. Le menu **⋮** permet de revenir aux réglages ou d'effacer la conversation.
